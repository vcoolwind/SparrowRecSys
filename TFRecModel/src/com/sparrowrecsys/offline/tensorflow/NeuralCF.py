...
from FileUtil import getOnlineServerFileBySubdir,getOutputModelDataDirBySubdir

# Training samples path, change to your local path
train_file = "trainingSamples.csv"
training_samples_file_path = tf.keras.utils.get_file(train_file,
                                                     getOnlineServerFileBySubdir("/webroot/sampledata/" + train_file))
# Test samples path, change to your local path
test_file = "testSamples.csv"
test_samples_file_path = tf.keras.utils.get_file(test_file,
                                                 getOnlineServerFileBySubdir("/webroot/sampledata/" + test_file))
...
movie_col = tf.feature_column.categorical_column_with_identity(key='movieId',
                                                               num_buckets=1001)
...
tf.keras.models.save_model(
    model,
    getOutputModelDataDirBySubdir("neuralcf/002"),
    overwrite=True,
