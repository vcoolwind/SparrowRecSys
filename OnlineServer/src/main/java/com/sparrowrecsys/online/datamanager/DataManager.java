...
import static com.sparrowrecsys.online.datamanager.DataFileUtil.ITEM2VEC_EMB;
import static com.sparrowrecsys.online.datamanager.DataFileUtil.LINKS;
import static com.sparrowrecsys.online.datamanager.DataFileUtil.MOVIES;
import static com.sparrowrecsys.online.datamanager.DataFileUtil.RATINGS;
import static com.sparrowrecsys.online.datamanager.DataFileUtil.USER_EMB;
import static com.sparrowrecsys.online.datamanager.DataFileUtil.get;
...
public class DataManager {
    ...
    public static void main(String[] args) throws Exception {
        getInstance().loadData(get(MOVIES),
                get(LINKS),
                get(RATINGS),
                get(ITEM2VEC_EMB),
                get(USER_EMB),
